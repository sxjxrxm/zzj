...
import com.zzj.db.dao.MsgImageMapper;
import com.zzj.db.dto.MsgImage;
import com.zzj.db.model.CourseMsgVO;

/**
 * <p><strong>类名: </strong></p>MsgImageBlo <br/>
 * <p><strong>功能说明: </strong></p>这个类是封在线课堂图片模块，数据库操作类. <br/>
 ...
 */
@Service
public class MsgImageBlo {
	
	/**
	 * MsgImageBlo表操作Mapper
	 */
	@Autowired
	private MsgImageMapper mapper;
     ...
     * @return Integer 插入结果
     */
    public Integer insertSelective(MsgImage record){
