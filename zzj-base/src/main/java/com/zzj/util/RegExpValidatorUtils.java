 ...
 * File Name:RegExpValidatorUtils.java
...
/**
 * <p><strong>类名: </strong></p>RegExpValidatorUtils <br/>
 * <p><strong>功能说明: </strong></p>JAVA正则表达式工具类。<br/>
...
public class RegExpValidatorUtils {
	...
	/**
	 * 验证注册时输入密码长度 (6-20位英文数字)
	 * @param str
	 * @return 如果是符合格式的字符串,返回 <b>true </b>,否则为 <b>false </b>
	 */
	public static boolean isRegisterPasswLength(String str) {
		String regex = "^[A-Za-z0-9]{6,20}$";
		return match(regex, str);
	}
