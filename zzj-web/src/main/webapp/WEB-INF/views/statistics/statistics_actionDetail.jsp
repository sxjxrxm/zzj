...
<head>
    ...
    <script type="text/javascript">
        var link = "<%=path %>/statistics/actionDetail.htm";
        // 返回
    	function back() {
        ...
        // CSV功能
	    function CSV(){
	    	document.forms[0].action = "<%=path %>/statistics/actionDetailCSV.htm";
	  		document.forms[0].submit();
		}
    </script>
</head>
<body>
	<form id="form" action="" method="post">
		...
		<table class="tb" id="list" >
			<tbody>
				<tr class="treven">
					...
					<th class="thCss">${handleTypeName}时间</th>
            	...
            	<tr>   
	                ...
	                <!-- 操作时间 -->
	                <td style='text-align:center;'><fmt:formatDate value="${item.handleTime}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
	                <!-- 用户昵称 -->
		...
		<!-- 页面回显使用的数据 -->
		<input type="hidden" value="${selectKey.topicName}" name="selectKey.topicName"/>
		...
		<input type="hidden" value="${handleTypeName}" name="handleTypeName"/>
	</form>
</body>
</html>